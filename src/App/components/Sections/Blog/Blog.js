                    ...
                    <div className="row">
                      ...
                      <div id="blog1" className="p-0 col-12 col-lg-7 ">
                        <div className=" postOne mx-lg-auto mt-5 ">
                          ...
                          <p className="small authorInfo text-white mb-1 pl-sm-4 pl-lg-2 pb-lg-2">John
                            Doe <span
                                className="verticalBar">|</span> Category <span
                                className="verticalBar">|</span> November
                            22nd,2018 </p>
                        </div>
                      </div>
                      <div
                          className="col-12 col-lg-5 px-0 "> {/* container for blog 2 and 3 */}
                        {/* blog two */}
                        <div id="blog2" className="col-12 p-0 ">
                          <div className=" postTwo ">
                            ...
                            <p className="small authorInfo text-white mb-1 pl-sm-4 pl-lg-2 ">John
                              Doe <span
                                  className="verticalBar">|</span> Category <span
                                  className="verticalBar">|</span> November
                              22nd,2018 </p>
